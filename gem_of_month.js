function gem_month() {
    ...
    if (x == "06") {
        document.getElementById("topic").innerHTML = "เดือนมิถุนายน : มุกดาหาร, เจ้าสามสี, ไข่มุก";
    ...
    if (x == "11") {
        document.getElementById("topic").innerHTML = "เดือนพฤศจิกายน : บุษราคัม, ซิทริน, โทแพซ";
    ...
    if (x == "12") {
        document.getElementById("topic").innerHTML = "เดือนธันวาคม : เทอร์คอยซ์, เพทาย";
